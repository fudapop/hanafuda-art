<template>
  <div class="min-h-screen">
    ...
    <Transition appear enter-active-class="duration-300 ease-out" enter-from-class="translate-y-4 opacity-0"
      enter-to-class="opacity-100" leave-active-class="duration-300 ease-in" leave-from-class="opacity-100"
      leave-to-class="translate-y-4 opacity-0">
      <div v-if="user !== null" class="absolute inset-0 h-full mx-auto pointer-events-none top-1/3 w-max isolate">
      ...
      <div v-else
        ...
        <div class="max-w-sm mx-auto w-max lg:w-96">
          <div class="flex items-center">
            ...
            <h2 class="ml-4 text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-50 dark:bg-gray-800">
              Welcome!
            </h2>
          </div>
            ...
            <div class="mt-10">
              <div class="relative">
                ...
                <div class="relative flex justify-center text-sm font-medium leading-6">
                  <span class="px-6 text-gray-900 bg-white dark:text-gray-300 dark:bg-gray-800">Or continue with</span>
                </div>
              </div>
              ...
              <div class="grid gap-4 mt-6">
                <button type="button" @click="() => loginWithOAuth('google')"
                  ...
                  <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="31.27" height="32" viewBox="0 0 256 262">
                    <path fill="#4285F4"
