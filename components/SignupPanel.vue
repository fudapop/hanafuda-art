    ...
    <div class="px-4 mt-10">
        <div class="relative">
            ...
            <div class="relative flex justify-center text-sm font-medium leading-6">
                <span class="px-6 text-gray-900 bg-white dark:text-gray-50 dark:bg-gray-800">Sign in with</span>
            </div>
        </div>
        <div class="grid gap-4 px-4 mt-6">
            <Button :action="() => loginWithOAuth('google')"
            ...
            <Button :action="() => loginWithOAuth('github')"
