            ...
            <div
              ...
              <div class="px-4 py-5 bg-white border-b border-gray-200 sm:px-6">
                <div class="flex flex-wrap items-end justify-between -mt-2 -ml-4 sm:flex-nowrap">
                  ...
                  <div v-if="decisionIsPending" v-hide:from="'p2'" class="flex flex-shrink-0 gap-2 ml-4">
              ...
              <!-- YAKU LIST -->
              <ul role="list" class="min-w-[320px] grid p-2 gap-4 md:grid-cols-[repeat(2,minmax(360px,1fr))]"
                v-if="roundNotADraw">
                  ...
                  <div
                    ...
                    <div class="[--card-height:60px] w-max pointer-events-none">
                      <ListGrid :cols="'auto'" :rows="1" flow="column">
                        <CardList :cards="YAKU[yaku].find(collection[recordedWinner!])" :stack="true" />
                      </ListGrid>
                    </div>
                  </div>
                  <!-- YAKU TITLE -->
                  <p class="block mt-2 text-sm font-semibold tracking-wide text-gray-900 truncate pointer-events-none">
                    {{ yaku.toUpperCase() }}
                  </p>
                  <!-- YAKU POINTS -->
