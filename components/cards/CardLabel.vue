<template>
  ...
  <span class="absolute top-0 z-[31] text-white text-[9px] [font-family:'Potta_One'] left-1">
    {{ CARDS[card].month }}
  </span>
  <span
  ...
  <span class="absolute bottom-0 z-[31] text-[9px] text-white [font-family:'Potta_One'] left-1">
  ...
  <span class="absolute bottom-0 z-[31] text-white text-[9px] [font-family:'Potta_One'] right-1">
    {{ CARDS[card].month }}
  </span>
  <span
  ...
  <span class="absolute top-0 z-[31] text-[9px] text-white [font-family:'Potta_One'] right-1">
    {{ CARDS[card].type[0].toUpperCase() }}
  </span>
</template>
