          ...
          <div class="max-w-2xl mx-auto gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              ...
              <div class="flex items-center mt-10 gap-x-6">
                <NuxtLink to="/play"
                  ...
                  Play the game</NuxtLink>
                <NuxtLink to="/gallery" class="z-10 text-sm font-semibold leading-6 text-gray-900">Browse designs <span
            ...
            <div class="flex justify-end gap-8 mt-14 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
              <div
                ...
                <div class="relative">
                  <nuxt-img provider="cloudinary" :modifiers="{ q: 'auto' }" width="176"
                    src="/v1690081689/new-hanafuda-cards/cherry-2020/matsu-ni-tsuru_nl2wn8.png" alt=""
                    class="object-cover w-full shadow-lg roundmd-md bg-gray-900/5" />
                  <div class="absolute inset-0 rounded-md pointer-events-none ring-1 ring-inset ring-gray-900/10" />
                </div>
              </div>
              <div class="flex-none mr-auto space-y-8 w-44 sm:mr-0 sm:pt-52 lg:pt-36">
                <div class="relative">
                  <nuxt-img provider="cloudinary" :modifiers="{ q: 'auto' }" width="176"
                    src="/v1690081724/new-hanafuda-cards/cherry-2020/kiri-ni-ho-oh_gzymc9.png" alt=""
                    class="object-cover w-full rounded-md shadow-lg bg-gray-900/5" />
                  <div class="absolute inset-0 rounded-md pointer-events-none ring-1 ring-inset ring-gray-900/10" />
                </div>
                <div class="relative">
                  <nuxt-img provider="cloudinary" :modifiers="{ q: 'auto' }" width="176"
                    src="/v1690081667/new-hanafuda-cards/cherry-2020/sakura-ni-maku_oqvhkg.png" alt=""
                    class="object-cover w-full rounded-md shadow-lg bg-gray-900/5" />
                  <div class="absolute inset-0 rounded-md pointer-events-none ring-1 ring-inset ring-gray-900/10" />
                </div>
              </div>
              <div class="flex-none pt-32 space-y-8 w-44 sm:pt-0">
                <div class="relative">
                  <nuxt-img provider="cloudinary" :modifiers="{ q: 'auto' }" width="176"
                    src="/v1690081669/new-hanafuda-cards/cherry-2020/susuki-ni-tsuki_kgabpy.png" alt=""
                    class="object-cover w-full rounded-md shadow-lg bg-gray-900/5" />
                  <div class="absolute inset-0 rounded-md pointer-events-none ring-1 ring-inset ring-gray-900/10" />
                </div>
                <div class="relative">
                  <nuxt-img provider="cloudinary" :modifiers="{ q: 'auto' }" width="176"
                    src="/v1690081705/new-hanafuda-cards/cherry-2020/yanagi-ni-ono-no-toufuu_wfjyix.png" alt=""
                    class="object-cover w-full rounded-md shadow-lg bg-gray-900/5" />
                  <div class="absolute inset-0 rounded-md pointer-events-none ring-1 ring-inset ring-gray-900/10" />
                </div>
              </div>
