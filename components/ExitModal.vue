                        ...
                        <DialogPanel
                            ...
                            <div>
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">Leaving the
                                        game...</DialogTitle>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">The game will be forfeited and progress will not be
                                            saved. Are you sure you want to leave?</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                <button type="button"
                                    ...
                                    @click="$emit('cancel')">No, keep playing</button>
                                <button type="button"
                                    ...
                                    @click="$emit('exit-game')" ref="cancelButtonRef">Yes, leave the game</button>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
                </div>
