  ...
  <HeadlessPopover class="relative inline-block text-left">
    <div>
      <HeadlessPopoverButton
        class="inline-flex w-full justify-center gap-x-1.5 rounded-lg bg-gray-50/20 dark:bg-gray-700/50 px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-gray-50 shadow-sm ring-1 ring-inset ring-gray-300/50 dark:ring-gray-500/50 hover:bg-gray-50 dark:hover:bg-gray-600">
        <span class="sr-only">
          Options
        </span>
        <AdjustmentsHorizontalIcon class="w-8 h-8 text-gray-700 dark:text-gray-400" aria-hidden="true" />
      </HeadlessPopoverButton>
    </div>
    <HeadlessPopoverOverlay class="fixed inset-0 z-40 bg-black opacity-50" />
      <HeadlessPopoverPanel :unmount="false"
        class="absolute top-0 right-0 z-50 w-[calc(100vw-4rem)] sm:w-[600px] min-h-[60svh] mt-2 ml-8 origin-top-right bg-white dark:bg-gray-800 rounded-lg shadow-lg ring-1 ring-black dark:ring-gray-600 ring-opacity-5 focus:outline-none">
        ...
        <HeadlessTabGroup>
          <HeadlessTabList class="flex p-1 space-x-1 rounded-lg shadow-inner bg-blue-900/20 dark:bg-blue-300/20">
