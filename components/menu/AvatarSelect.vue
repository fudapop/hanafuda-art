<template>
  <HeadlessPopover>
    ...
    >
      ...
      >
        <div
          class="flex items-center justify-center px-3 py-3 shadow-inner bg-blue-900/20 dark:bg-blue-300/20 rounded-[inherit]"
        >
          <h3 class="text-lg font-semibold tracking-wide text-blue-700 dark:text-gray-200">
            Choose Your Avatar
          </h3>
        </div>
